function [testFit,trainFit,param_mean] = fit_model_KA(A,dt,spiketrain,filter,modelType,numFolds)
...
for k = 1:numFolds
    ...
    [param] = fminunc(@(param) ln_poisson_model_KA(param,data,modelType),init_param,opts);

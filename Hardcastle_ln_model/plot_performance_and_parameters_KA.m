...
box off
set(gca,'fontsize',12)
set(gca,'XLim',[0 7]); set(gca,'XTick',1:7)
set(gca,'XTickLabel',{'PST','PS','PT','ST','P','S','T'});
legend('Model performance','Selected model','Baseline', 'box', 'off', 'Location','north', 'Orientation','horizontal', 'fontsize', 12)

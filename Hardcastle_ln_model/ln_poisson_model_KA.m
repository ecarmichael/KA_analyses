function [f, df, hessian] = ln_poisson_model_KA(param,data,modelType)
...
% find the parameters
numPos = 400; numHD = 18; numSpd = 10; numTheta = 20; % hardcoded: number of parameters
...
if ~isempty(param_theta)
    [J_theta,J_theta_g,J_theta_h] = rough_penalty_1d(param_theta,b_th);
end
